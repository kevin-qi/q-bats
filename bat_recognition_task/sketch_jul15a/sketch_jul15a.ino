...
// Feeder Beam Break
#define P1_FEED_BB_PIN A10
#define P2_FEED_BB_PIN A11
#define Q1_FEED_BB_PIN A12
...
void setup() {
 ...
 bounce_A_STIM_BB.attach(BB_STIM_PIN, INPUT_PULLUP);
 //bounce.attach(BB_SNIFF_PIN, INPUT);
 //bounce.attach(BB_REW_PIN, INPUT);
 bounce_A_STIM_BB.interval(500);

 bounce_A_SNIF_BB.attach(BB_SNIFF_PIN, INPUT_PULLUP);
 bounce_A_SNIF_BB.interval(500);

 bounce_P1_FEED_BB.attach(BB_REW_PIN, INPUT_PULLUP);
